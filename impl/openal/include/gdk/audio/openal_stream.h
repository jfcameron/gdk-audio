...
namespace gdk::audio
{
    ...
    class openal_stream : public openal_sound
    {
        ...
        using pcm_buffer_type = std::array<short, 32768>; //2^15 // 2^14 is the smallest buffer size that doesnt cause playback failure with my test file. I dont understand how to choose buffer size, this will undoubtedly become a.. learning opportunity in the future.
    ...
    public:
        ...
        openal_stream(const std::shared_ptr<file_buffer_type> aOggVorbisData);
